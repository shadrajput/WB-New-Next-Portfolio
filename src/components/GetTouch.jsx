        ...
        <>
            <div className='px-7 mt-24 xl:mt-24 xl:px-36'>
                <div className=" w-full flex xs:flex-col lg:flex-row justify-between items-center h-[600px] bg-[#000000] px-5  xl:px-20  relative overflow-hidden  rounded-2xl">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-center lg:justify-between w-full space-y-10">
                        <div className='lg:w-[55%] xl:w-[60%] space-y-7 p-5 z-50'>
                            ...
                            <div className="flex items-center justify-center w-full lg:items-start lg:justify-start">
                                <Link href="https://calendly.com/wellbenix/website-strategy-for-online-sales?month=2024-02">
                                    <button className="rounded-full px-10 py-2 xl:py-3 bg-[#1179fc] font-bold text-white uppercase hover:bg-white hover:text-[#1179fc] duration-300 ">Book A Call</button>
                                </Link>
                            </div>
                        </div>


                        <div className=' w-full px-5 lg:w-[35%] mt-1 rounded-lg sm:w-1/2  xl:w-1/3 flex justify-center items-center lg:absolute lg:-bottom-40 lg:right-20 xl:right-20 xl:top-32'>
