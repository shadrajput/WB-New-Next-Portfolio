    ...
    <>
      <div className=" hero-section h-[800px] lg:h-[750px] xl:h-[700px] flex justify-center items-center pt-24 lg:pt-14 px-7 sm:px-14 md:px-20">
        <div className="">
          ...
          <h1 className="text-[40px] sm:text-[45px] md:text-[55px] lg:text-[75px] xl:text-[85px] font-bold text-white text-center leading-tight pb-7 ">Designing digital store for fashion leaders generating <span className="bg-gradient-to-r from-[#1179fc] to-[#dc82fc] text-transparent bg-clip-text">sales with flair.</span></h1>
