          ...
          <div className=' xs:py-5 xl:p-4'>
            ...
            <div className='flex xs:flex-col sm:flex-row xs:justify-center xs:items-center sm:items-start xl:justify-start xl:items-start space-x-5 p-3'>
              ...
              <div>
                ...
                <p className='xs:text-center sm:text-start sm:text-sm'>We are committed to delivering client-centric IT solutions, tailored to your unique needs, with a focus on excellence and and innovation.</p>
              </div>
            </div>
          </div>
